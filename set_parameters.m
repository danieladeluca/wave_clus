...
par.sr = 2.441406250000000e+04;                      % sampling rate (in Hz). This parameter will be only used if the data file don't have a sr. 
...
par.sort_fmax = 6000;                % low pass filter for sorting (default 3000) 
